{{-- resources/views/assessment/cyberbulling/person_action/form/result.blade.php --}}
@extends('layouts.assessment.cyberbulling.person_action.form.result')
@section('content')
    <div class="bg-white w-full flex-grow rounded-t-[50px] px-6 pt-8 flex flex-col mt-8 pb-10">
        ...
        <div class="bg-white w-full max-w-2xl mx-auto rounded-t-[50px] px-6 pt-8 flex flex-col mt-2 pb-10 ">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="w-full max-w-md bg-gray-100 h-4 rounded-full overflow-hidden mb-4">
                ...
                <div class="border-t border-gray-300 w-full pt-6 mt-4">
                    <h2 class="text-xl font-medium text-[#3E36AE] mb-4">ผลการประเมิน</h2>
                    @if ($percentage == 0)
                ...
                <div class="flex justify-center mt-10">
                    <a href="/assessment/cyberbulling/person_action/form"
                        class="text-lg px-12 py-3 rounded-xl text-white font-medium shadow-md bg-[#929AFF]">
        ...
        <div class="flex justify-center mt-10">
            <a href="{{ route('main') }}" class="text-lg px-8 py-3 rounded-xl text-white font-medium shadow-md bg-[#c0c0c0]">
                กลับหน้าหลัก
            </a>
        </div>
    </div>

{{-- resources/views/assessment/cyberbulling/victim/form/result.blade.php --}}
@extends('layouts.assessment.cyberbulling.victim.form.result')
@section('content')
        ...
        <div class="bg-white w-full max-w-2xl mx-auto rounded-t-[50px] px-6 pt-8 flex flex-col mt-2 pb-10 ">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex justify-center mt-10">
                    <a href="/assessment/cyberbulling/victim/form"

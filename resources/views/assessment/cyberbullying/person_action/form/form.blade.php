{{-- resources/views/assessment/cyberbullying/person_action/form/form.blade.php --}}
@extends('layouts.assessment.cyberbullying.person_action.form.form')
...
@section('content')
    ...
    @include('layouts.assessment.cyberbullying.percent')
@endsection

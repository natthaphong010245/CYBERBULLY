...
<div class="bg-white w-full flex-grow rounded-t-[50px] px-6 pt-8 flex flex-col mt-16">
    ...
    <!-- ใช้ลิงก์ปกติไม่มี data-fade-link หรือ animation -->
    <a href="{{ route('main') }}" 
       class="bg-[#929AFF] hover:bg-[#7B84EA] text-white py-2.5 px-6 rounded-2xl text-center transition duration-300 w-[85%] mx-auto text-[20px]">
        เข้าสู่เว็บไซต์
    </a>
    ...
    <div class="py-3 text-center text-sm mt-auto">
        <p class="text-[16px]">เข้าสู่ระบบสำหรับผู้ดูแลที่นี่ <a href="{{ route('login') }}" class="text-[#3F359E] text-[16px]">เข้าสู่ระบบ</a></p>
    </div>
</div>

...
@section('content')
    <div class="bg-white w-full flex-grow rounded-t-[50px] px-10 pt-8 flex flex-col mt-16">
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <select id="role" name="role"
                        class="w-full px-6 pr-14 py-3 border {{ $errors->has('role') ? 'border-red-500' : 'border-gray-400' }} rounded-2xl text-gray-700 focus:outline-none focus:border-[#929AFF] appearance-none">
            ...
            <div class="mb-4" id="school-container">
                ...
                <div class="relative">
                    <select id="school" name="school"
                        class="w-full px-6 pr-14 py-3 border {{ $errors->has('school') ? 'border-red-500' : 'border-gray-400' }} rounded-2xl text-gray-700 focus:outline-none focus:border-[#929AFF] appearance-none">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" placeholder="กรุณากรอกชื่อ" value="{{ old('name') }}"
                    class="w-full px-6 py-3 border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-400' }} rounded-2xl text-gray-700 placeholder-gray-500 focus:outline-none focus:border-[#929AFF]">
                @if ($errors->has('name'))
                    <div class="flex items-center mt-1 text-red-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20"
                            fill="currentColor">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="lastname" name="lastname" placeholder="กรุณากรอกนามสกุล"
                    value="{{ old('lastname') }}"
                    class="w-full px-6 py-3 border {{ $errors->has('lastname') ? 'border-red-500' : 'border-gray-400' }} rounded-2xl text-gray-700 placeholder-gray-500 focus:outline-none focus:border-[#929AFF]">
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation"
                    ...
                    class="w-full px-6 py-3 border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-gray-400' }} rounded-2xl text-gray-700 placeholder-gray-500 focus:outline-none focus:border-[#929AFF]">
        ...
        <!-- Cancel Button -->
        <a href="{{ route('home') }}"
            class="bg-[#ffffff] py-2.5 px-6 rounded-2xl text-center transition duration-300 w-[100%] mx-auto text-[20px] mt-2 mb-8 text-gray-400 border border-gray-400 font-bold active:border-white">
            ยกเลิก
        </a>

<button id="infoBtn" class="absolute top-4 right-4 h-8 w-8 flex items-center justify-center rounded-full bg-white text-gray-700 shadow-md">
...
<div id="infoModal" class="modal fixed inset-0 flex items-center justify-center z-50">
    ...
    <div class="modal-content bg-white w-11/12 max-w-xl mx-auto rounded-lg shadow-lg z-50 transform scale-100 transition-transform duration-300">
        
        <div class="flex justify-between items-center pl-4 pr-4 pt-4 relative mt-2 mr-2">
            <button id="closeBtn" class="h-8 w-8 flex items-center justify-center rounded-full text-gray-500 hover:text-gray-700 absolute top-0 right-0">
        ...
        <div class="modal-body pl-3 pr-3 pb-3">
            ...
            <div class="flex justify-center space-x-3 mb-4 border-b border-gray-300 pb-4">
                ...
                @foreach($certifications as $cert)
                    <img src="/images/{{ $cert['image'] }}" alt="{{ $cert['alt'] }}" class="h-11 w-11 object-contain">
                @endforeach
            </div>
            ...
            <div class="mt-2">
                ...
                <div class="p-3 text-center">
                    <p class="text-[14px] font-medium">{{ $member['name'] }}</p>
                    <p class="text-[12px]">{{ $member['position1'] }}</p>
                    <p class="text-[12px]">{{ $member['position2'] }}</p>
                </div>
                @endforeach
                ...
                <div class="p-3 text-center">
                    ...
                    <p class="text-[12px]">สาขาวิชาสาธารณสุขศาสตร์ และศูนย์ความเป็นเลิศการวิจัยสุขภาพชนชาติพันธุ์</p>
                    <p class="text-[12px]">สำนักวิชาวิทยาศาสตร์สุขภาพ มหาวิทยาลัยแม่ฟ้าหลวง</p>
                </div>
            </div>
        </div>
    </div>

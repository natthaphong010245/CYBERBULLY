...
<body class="relative">
    @include('layouts.assessment.cyberbullying.person_action.form.nav')
    @include('layouts.assessment.cyberbullying.person_action.form.logo')
    @yield('scripts')
    @include('layouts.assessment.cyberbullying.person_action.script')
</body>

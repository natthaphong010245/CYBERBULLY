...
<body class="relative">
    @include('layouts.assessment.cyberbulling.overview.form.nav')
    @include('layouts.assessment.cyberbulling.overview.form.logo')
    @yield('scripts')
    @include('layouts.assessment.cyberbulling.overview.script')
</body>

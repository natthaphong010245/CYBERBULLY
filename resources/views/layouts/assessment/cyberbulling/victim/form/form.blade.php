...
<body class="relative">
    @include('layouts.assessment.cyberbulling.victim.form.nav')
    @include('layouts.assessment.cyberbulling.victim.form.logo')
    @yield('scripts')
    @include('layouts.assessment.cyberbulling.victim.script')
</body>

...
@section('content')
        ...
        <div class="flex justify-center mb-8">
            <div class="bg-white rounded-2xl shadow-lg">
                <div class="rounded-lg overflow-hidden">
                    <img src="{{ asset('images/game/1/physical_bullying.png') }}" alt="Physical Bullying Scenario" class="w-full h-52 object-cover rounded-lg">
                </div>
            </div>
        </div>
    ...
    <div id="failure-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-30">
        <div class="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full mx-4 text-center">
            ...
            <div class="mb-4">
                <img src="{{ asset('images/game/1/physical_bullying.png') }}" alt="Physical Bullying" class="w-full h-auto object-cover rounded mb-2">
                <p class="text-indigo-700 font-bold text-xl">การรังแกทางกาย</p>
            </div>

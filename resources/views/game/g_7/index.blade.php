...
@section('content')
    <div class="card-container space-y-6 px-6 md:px-0">
        <div class="text-center mb-8">
            <h2 class="text-lg font-bold text-indigo-800">อยากรู้ไหมว่า สาเหตุของการกลั่นแกล้ง</h2>
            <h2 class="text-lg font-bold text-indigo-800">บนโลกออนไลน์ เกิดจากอะไร.....</h2>
        </div>

...
@section('content')
    <div class="card-container space-y-6 px-6 md:px-0 mb-6">
        <div class="text-center mb-2">
            ...
            <h2 class="text-lg font-bold text-indigo-800">CYBERBULLYING</h2>
        </div>
        
        <!-- Scenario Image -->
        <div class="flex justify-center mb-8">
            <div class="rounded-lg overflow-hidden shadow-lg">
                <img src="{{ asset('images/game/5/cyberbullying.png') }}" alt="Traditional Bullying Scenario" class="w-full h-64 object-cover">
            </div>
        </div>
        ...
        <div class="mb-2">
            ...
            <div class="grid grid-cols-2 gap-3 max-w-xs mx-auto mb-6" id="sequence-slots">
                <div class="sequence-slot border-2 border-dashed border-indigo-300 rounded-lg h-20 flex items-center justify-center relative" data-position="1">
                    <span class="slot-number text-2xl font-bold text-indigo-400">1</span>
                    <div class="slot-content hidden w-full h-full"></div>
                </div>
                <div class="sequence-slot border-2 border-dashed border-indigo-300 rounded-lg h-20 flex items-center justify-center relative" data-position="2">
        ...
        <div class="mb-2">
            ...
            <div class="grid grid-cols-2 gap-3 max-w-xs mx-auto" id="character-options">
                <div class="character-option cursor-pointer h-20" data-character="bully" data-correct-position="1">
                    <div class="bg-indigo-500 text-white rounded-lg p-2 text-center font-medium transition-all hover:bg-indigo-600 h-full flex flex-col justify-center">
                        <div class="text-lg">ผู้รังแก</div>
                        <div class="text-xs">BULLY</div>
                    </div>
                </div>
                <div class="character-option cursor-pointer h-20" data-character="victim" data-correct-position="2">
                    <div class="bg-indigo-500 text-white rounded-lg p-2 text-center font-medium transition-all hover:bg-indigo-600 h-full flex flex-col justify-center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let availableOptions = ['bully', 'victim'];
            ...
            function addToSequence(character, slot) {
                ...
                slotContent.innerHTML = `
                    <div class="selected-character bg-indigo-500 text-white rounded-lg w-full h-full flex flex-col justify-center items-center text-center font-medium relative transition-all hover:bg-indigo-600">
                        <div class="${characterText.mainSize}">${characterText.main}</div>
            ...
            function checkAnswer() {
                const correctSequence = ['bully', 'victim'];
